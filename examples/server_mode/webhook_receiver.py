...
if __name__ == "__main__":
    ...
    if "--test" in sys.argv:
        ...
        print(f"  Endpoints:")
        print(f"    POST /webhook/scrape")
        print(f"    POST /webhook/crawl")
        print(f"    POST /webhook/error")
        print(f"    GET  /webhook/events")
        print(f"    GET  /health")
        print(f"\n  Start server:")
        print(f"    uvicorn examples.server_mode.webhook_receiver:app --port {PORT}")
        print(f"\n  Send test webhooks:")
        print(f"    python examples/server_mode/webhook_receiver.py --test")
        print()
